      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-center gap-10 px-6">
        ...
        <div className="md:w-1/2 text-center md:text-left relative">
          ...
          <div className="relative mt-4">
            ...
            >
              <p className="text-gray-800 mb-4">
                We specialize in sourcing top-tier talent — skilled, semi-skilled, and
                unskilled — across blue and white-collar categories to meet the
                diverse workforce needs of global organizations.
              </p>
            ...
            >
              {/* Empty space reserved to prevent layout shift */}
            </div>
