  ...
  return (
    <section className="w-screen min-h-screen bg-[#EFF0F1] flex items-center justify-center py-6 sm:py-8 md:py-12 -mx-4">
      ...
      <div
        ...
        style={{ width: "100vw", maxWidth: "1264px", height: "auto", minHeight: '320px', gap: 0 }}
      >
        {/* Row 1 */}
        <div className="bg-white p-4 sm:p-4 md:p-4 flex flex-col justify-start items-start col-span-1 md:col-span-2 lg:col-span-2 row-span-1 lg:row-span-1">
        ...
        <div className="col-span-1 row-span-1">
          <Image src="/scaffolding.png" alt="Scaffolding" className="w-full h-[80px] sm:h-[100px] md:h-[110px] object-cover" width={150} height={150} loading="lazy" />
        </div>
        <div className="bg-[#a6bbc7] p-4 sm:p-4 md:p-4 flex flex-col justify-start items-start col-span-1 row-span-1">
          <ul className="text-sm sm:text-base lg:text-base text-black list-disc pl-5 space-y-1 sm:space-y-2">
            <li>Interior & Fitout</li>
            <li>Healthcare & Nursing</li>
          </ul>
        ...
        {/* Row 2 */}
        <div className="bg-[#4a6173] p-4 sm:p-4 md:p-4 flex flex-col justify-start items-start col-span-1 row-span-1">
        ...
        <div className="col-span-1 row-span-1">
          <Image src="/lathe_worker.png" alt="Lathe Worker" className="w-full h-[80px] sm:h-[100px] md:h-[110px] object-cover" width={150} height={150} loading="lazy" />
        </div>
        <div className="bg-[#d05c4e] p-4 sm:p-4 md:p-4 flex flex-col justify-start items-start col-span-1 row-span-1">
          <ul className="text-sm sm:text-base lg:text-base text-white list-disc pl-5 space-y-1 sm:space-y-2">
            <li>Hospitality</li>
            <li>Facility Management</li>
          </ul>
        ...
        <div className="col-span-1 row-span-2">
          <Image src="/construction_workers.png" alt="Construction Workers" className="w-full h-[80px] sm:h-[100px] md:h-[110px] object-cover" width={150} height={300} loading="lazy" />
        </div>
        {/* Row 3 */}
        <div className="col-span-1 row-span-1">
          <Image src="/painting_wall.png" alt="Painting Wall" className="w-full h-[80px] sm:h-[100px] md:h-[110px] object-cover" width={150} height={150} loading="lazy" />
        </div>
        <div className="bg-[#a89d8d] p-4 sm:p-4 md:p-4 flex flex-col justify-start items-start col-span-1 row-span-1">
          <ul className="text-sm sm:text-base lg:text-base text-white list-disc pl-5 space-y-1 sm:space-y-2">
            <li>Skilled & Semi-Skilled Workers</li>
          </ul>
        </div>
        <div className="col-span-1 row-span-1">
          <Image src="/hospitality.png" alt="Hospitality" className="w-full h-[80px] sm:h-[100px] md:h-[110px] object-cover" width={150} height={150} loading="lazy" />
        </div>
      </div>
    </section>
  );
