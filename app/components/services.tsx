    ...
    <div className="bg-[#E1ECF7] w-screen h-[907px] py-16 px-4 font-sans text-gray-800 flex justify-center">
      <div className="max-w-[1200px] w-full mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Recruitment Card */}
          <div className="relative rounded-2xl overflow-hidden shadow-md h-[285px]">
            <img
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-md bg-white p-6 flex flex-col justify-center h-[285px]">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-md bg-[#0B1A35] text-white p-6 flex flex-col justify-center h-[250px]">
          ...
          {/* Technical Services */}
          <div className="relative rounded-2xl overflow-hidden shadow-md bg-white p-6 flex flex-col justify-center h-[250px] text-center">
          ...
          {/* Air Ticketing */}
          <div className="relative rounded-2xl overflow-hidden shadow-md h-[250px]">
            <img
